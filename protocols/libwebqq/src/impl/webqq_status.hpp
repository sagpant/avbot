...
{
public:
	change_status_op(std::shared_ptr<qqimpl::WebQQ> webqq, LWQQ_STATUS status, Handler handler)
...
make_change_status_op(std::shared_ptr<qqimpl::WebQQ> webqq, LWQQ_STATUS status, Handler handler)
{
...
template<class Handler>
void  async_change_status(std::shared_ptr<qqimpl::WebQQ> webqq, LWQQ_STATUS status, Handler handler)
{
