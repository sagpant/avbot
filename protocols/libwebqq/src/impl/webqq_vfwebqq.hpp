...
{
public:
	update_vfwebqq_op(std::shared_ptr<qqimpl::WebQQ> webqq, Handler handler)
...
make_update_vfwebqq_op(std::shared_ptr<qqimpl::WebQQ> webqq, Handler handler)
{
...
template<class Handler>
void  async_update_vfwebqq(std::shared_ptr<qqimpl::WebQQ> webqq, Handler handler)
{
